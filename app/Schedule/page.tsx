                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {matchesByDate[date].map((match, index) => (
                    ...
                    >
                      ...
                      <p className="text-sm sm:text-lg text-[#102F8E]">
                        Lokasi: {match.lokasi}
                      </p>
                      ...
                      <div className="flex mt-4 w-full">
                        <div className="w-[15%] flex flex-col items-center xs:border-r-2 xs:border-[#102F8E] px-2">
                          <p className="text-[#102F8E] text-sm xs:text-xl sm:text-2xl md:text-xl lg:text-3xl">
                            {match.waktu}
                          </p>
                          <p className="text-[#102F8E] text-xs xs:text-base md:text-sm lg:text-lg">
                            WIB
                          </p>
                        </div>
